...
final class MovieViewModel: ObservableObject {
    ...
    func loadMovies() async {
        ...
        case .popular : await fetch { try await repository.fetchPopularMovies() }
        case .topRated: await fetch { try await repository.fetchTopRatedMovies() }
        case .upcoming: await fetch { try await repository.fetchUpcomingMovies() }
        case .trending: await fetch { try await repository.fetchTrendingMovies() }
        }
    }
